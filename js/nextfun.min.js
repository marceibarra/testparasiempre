...
! function (a) {
	...
	o(), a(window).scroll(o), a(".ingressos-modal").on("show.bs.modal", function (o) {
		a(".navbar").addClass("d-none")
	}), a(".ingressos-modal").on("hidden.bs.modal", function (o) {
 ...
 $(function() {
    $('.scroll-down').click (function() {
      $('html, body').animate({scrollTop: $('section.villamix').offset().top }, 'slow');
      return false;
    });
  });
